...
class Game():
    def __init__(self):
        ...
        self.win.tracer(0)
        self.win.listen()        
        self.colors = ['red', 'blue', 'green', 'yellow', 'orange', 'gold', 'purple']
        self.pen = Scoreboard()        
    ...
    def show_start_screen(self):      
        ...
        while self.waiting:
            self.win.bgcolor('black')
            self.pen.write('Cannnon game \n\n', align='center', font=('Courier', 24, 'normal'))
            self.pen.write('Press the "space" key to continue', align='center', font=('Courier', 24, 'normal'))
    ...
    def show_game_over_screen(self):
        ...
        while self.waiting:
            ...
            self.pen.write(f'GAME OVER - Score: {self.score} \n\n Press the "space" key for new game',
                      align='center', font=('Courier', 17, 'normal'))
